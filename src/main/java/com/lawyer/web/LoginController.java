...
public class LoginController {
	...
	public String login(@Valid UserInfo user, BindingResult bindingResult, boolean rememberMe,
		...
		UsernamePasswordToken upToken = new UsernamePasswordToken(user.getAccount(), MD5Util.gerHsahMd5(user.getPassword()),rememberMe);
		try {
